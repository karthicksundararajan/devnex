...
import { OnlyInputNodeComponent } from '../components/demo/only-input-node.component/only-input-node.component';
import { ToolbarNodeComponent } from '../components/demo/toolbar-node.component/toolbar-node.component';
import { ResizableNodeComponent } from '../components/demo/resizable-node.component/resizable-node.component';
import { SizeNodeComponent } from '../components/demo/size-node.component/size-node.component';
import { PositionNodeComponent } from '../components/demo/position-node.component/position-node.component';
